...
public class TuningShop : MonoBehaviour, IInteract
{
    ...
    public void GenerateData()
    {
        ...
        recipeList.Add(0, new TuningRecipe("Rifle_0", 0
            , new string[] {"Stone_0" }
            , new int[] {1}));
        recipeList.Add(1, new TuningRecipe("Rifle_0", 1
            , new string[] { "Stone_0", "Stone_1" }
            , new int[] { 2, 2}));
        recipeList.Add(2, new TuningRecipe("Rifle_0", 2
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 3, 3, 3 }));
        recipeList.Add(3, new TuningRecipe("Rifle_0", 4
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 4, 4, 4 }));
        recipeList.Add(4, new TuningRecipe("Rifle_0", 5
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 5, 5, 5 }));
        recipeList.Add(5, new TuningRecipe("Rifle_0", 6
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 6, 6, 6 }));
        recipeList.Add(6, new TuningRecipe("Rifle_0", 7
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 7, 7, 7 }));
        recipeList.Add(7, new TuningRecipe("Rifle_0", 8
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 8, 8, 8 }));
        recipeList.Add(8, new TuningRecipe("Rifle_0", 9
            , new string[] { "Stone_0", "Stone_1", "Stone_2" }
            , new int[] { 9, 9, 9 }));
    ...
    {
        CFirebase.Instance.GetWeapon(0, "Rifle_0", 0, 10);
    }

    [ContextMenu("Get_AK-47")]
    public void Get_AK_47()
    {
        CFirebase.Instance.GetWeapon(100, "AK-47", 0, 20);
    }

    [ContextMenu("방어구 얻기")]
    public void Get_Armor_()
    {
        CFirebase.Instance.GetArmor(10000, "Rusty_Pendant", 1, 0, 20);
        CFirebase.Instance.GetArmor(20000, "Rusty_Gloves", 2, 0, 20);
        CFirebase.Instance.GetArmor(30000, "Rusty_Helmet", 3, 0, 20);
        CFirebase.Instance.GetArmor(40000, "Rusty_Breastplate", 4, 0, 20);
        CFirebase.Instance.GetArmor(50000, "Rusty_Boots", 5, 0, 20);
    }

    [ContextMenu("돌덩이 0")]
    public void Get__STONE()
    {
        for(int i = 2; i <= 200; i++)
        {
            CFirebase.Instance.GetItem("Stone_0", i);
        }
    }
}
