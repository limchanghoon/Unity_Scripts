...
public class Gun : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Q) && isQCoolDown == false)
        {
        ...
        else if (Input.GetKeyDown(KeyCode.Alpha1) && canPortalGun)
        {
            if (PhotonNetwork.InRoom)
        ...
        else if (Input.GetKeyDown(KeyCode.Alpha2) && canPortalGun)
        {
            if (PhotonNetwork.InRoom)
    ...
    {
        isQCoolDown = true;
        yield return rocketCooldown.CooldownCoroutine(0.5f);
        isQCoolDown = false;
    }
