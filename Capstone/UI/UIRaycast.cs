...
public class UIRaycast : MonoBehaviour
{
            ...
            if (raycastResults.Count > 0)
            {
                ...
                if(itemData_Mono != null && itemData_Mono.itemData.type != '-')
                {
                    ...
                    if(preObj == null || preObj != raycastResults[0].gameObject)
                    {
                        ...
                        SetDescription(itemData_Mono.itemData.itemName, itemDescription);
                    }
    ...
    public void SetDescription(string _itemName, TextMeshProUGUI _itemDescriptionText)
    {
        CFirebase.Instance.GetItemDescription(_itemName, _itemDescriptionText);
    }
