...
public class TuningNPC : MonoBehaviour, IInteract
{
    ...
    {
        CFirebase.Instance.GetWeapon(string.Empty, 0, "M16", 0, 10);
    }

    [ContextMenu("Get_AK-47")]
    public void Get_AK_47()
    {
        CFirebase.Instance.GetWeapon(string.Empty, 100, "AK-47", 0, 20);
    }

    [ContextMenu("방어구 얻기")]
    public void Get_Armor_()
    {
        CFirebase.Instance.GetArmor(string.Empty, 10000, "Rusty_Pendant", 1, 0, 20);
        CFirebase.Instance.GetArmor(string.Empty, 20000, "Rusty_Gloves", 2, 0, 20);
        CFirebase.Instance.GetArmor(string.Empty, 30000, "Rusty_Helmet", 3, 0, 20);
        CFirebase.Instance.GetArmor(string.Empty, 40000, "Rusty_Breastplate", 4, 0, 20);
        CFirebase.Instance.GetArmor(string.Empty, 50000, "Rusty_Boots", 5, 0, 20);
    }
